...
function SideBar(props: SideBarPropType) {
  ...
  return (
    <div className="flex flex-col bg-gray-700 rounded-lg font-mono items-center ml-auto mr-4 w-3/12 h-screen py-4 px-3 max-[900px]:w-full max-[900px]:h-auto max-[900px]:mb-3">
