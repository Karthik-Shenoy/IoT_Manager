    ...
    return (
        <>
            <Parallax image="../../../public/HeroPage.jpg">
                <div className="flex items-left flex-col md:pl-[100px] mr-[500px] md:scale-[1] scale-[0.5]">
                    <h1 className="text-white text-8xl font-mono font-bold mb-3 pb-3">Sensor<b className="text-schn-500">Flow</b></h1>
                    <p className="text-white text-justify font-mono font-bold text-xl">SensorFlow is a powerful web app that simplifies the process of managing and controlling your IoT devices and sensors. With SensorFlow, you can easily provision and monitor your devices, visualize data in real-time, and gain insights to optimize performance. Get started today and take control of your IoT devices with SensorFlow.</p>
